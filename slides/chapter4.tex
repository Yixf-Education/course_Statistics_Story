...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c4_plot_scatter_01.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_plot_bubble_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_plot_linechart_01.png}
  \end{figure}
\end{frame}
...
%   \begin{figure}
%     \centering
%     \includegraphics[width=0.9\textwidth]{c4_plot_runchart_01.png}
%   \end{figure}
% \end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_plot_runchart_02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{c4_plot_qq_01.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{c4_plot_barchart_01.png}
    \includegraphics[width=0.55\textwidth]{c4_plot_barchart_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.65\textwidth]{c4_plot_barchart_03.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_plot_histogram_01.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_plot_density_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.55\textwidth]{c4_plot_stem_01.png}\\
    \includegraphics[width=0.55\textwidth]{c4_plot_stem_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c4_plot_boxplot_01.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c4_plot_boxplot_02.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c4_plot_boxplot_03.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{c4_plot_violin_01.png}
    \includegraphics[width=0.45\textwidth]{c4_plot_violin_04.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{c4_plot_violin_02.png}
    \includegraphics[width=0.45\textwidth]{c4_plot_violin_03.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c4_plot_pie_01.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{c4_plot_pie_02.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.42\textwidth]{c4_plot_venn_01.png}
    \includegraphics[width=0.53\textwidth]{c4_plot_venn_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{c4_plot_venn_03.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c4_plot_biplot_01.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_plot_star_02.jpg}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c4_plot_star_03.jpg}\\
    \includegraphics[width=0.6\textwidth]{c4_plot_star_05.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{c4_plot_forest_01.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.55\textwidth]{c4_plot_heatmap_01.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c4_plot_volcano_01.jpg}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c4_plot_manhattan_01.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c4_plot_network_01.jpg}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.65\textwidth]{c4_plot_treemap_03.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{c4_plot_cartogram_00.png}
    \includegraphics[width=0.45\textwidth]{c4_plot_cartogram_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.65\textwidth]{c4_plot_cartogram_03.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{c4_plot_all_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_playfair_01.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_playfair_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_playfair_03.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{c4_playfair_04.jpg}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_nightingale_01.jpg}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{c4_snow_01.jpg}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c4_minard_01.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c4_minard_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.55\textwidth]{c4_minard_03.png}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c4_neurath_01.jpg}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{c4_case_line_income_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_case_line_income_02.png}
  \end{figure}
  \pause
  \vspace{-0.5em}
  \begin{block}{解析}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c4_case_line_income_03.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{“灰姑娘”到“白雪公主”的蜕变}
    \begin{figure}
      \centering
      \visible<1->{\includegraphics[width=0.22\textwidth]{c4_case_line_company_01.png}}
      \visible<2->{\includegraphics[width=0.28\textwidth]{c4_case_line_company_02.png}}
      \visible<3->{\includegraphics[width=0.22\textwidth]{c4_case_line_company_03.png}}
      \visible<4->{\includegraphics[width=0.155\textwidth]{c4_case_line_company_04.png}}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.58\textwidth]{c4_case_line_out_01.png}
  \end{figure}
  \vspace{-1em}
  \begin{block}{vs.}
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.48\textwidth]{c4_case_line_car_01.png}\quad
    \includegraphics[width=0.43\textwidth]{c4_case_line_car_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{非凡的牛市！？}
    \begin{figure}
      \centering
      \includegraphics[width=0.7\textwidth]{c4_case_line_shock_01.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{妇女更加倾向于使用暴力？}
    \begin{figure}
      \centering
      \includegraphics[width=0.68\textwidth]{c4_case_line_woman_01.png}
    \end{figure}
    \vspace{-1em}
    \pause
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_case_line_bar_01.png}
  \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c4_case_line_bank_01.png}\quad
    \includegraphics[width=0.46\textwidth]{c4_case_line_bank_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{对坐标的一部分进行延伸或者收缩}
    ...
    \begin{figure}
      \centering
      \visible<1->{\includegraphics[width=0.3\textwidth]{c4_case_line_axis_01.png}}
      \visible<2->{\includegraphics[width=0.33\textwidth]{c4_case_line_axis_02.png}}
      \visible<3->{\includegraphics[width=0.33\textwidth]{c4_case_line_axis_03.png}}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{1972～1988年发展的上升与下滑历程}
    \begin{figure}
      \centering
      \includegraphics[width=0.8\textwidth]{c4_case_line_car_03.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{邮资持续不变的假象}
    \begin{figure}
      \centering
      \includegraphics[width=0.8\textwidth]{c4_case_line_stamp_01.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{广告代理机构宣传自己的广告}
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{c4_case_line_other_01.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{薄饼“在2分钟之内开始提供能量”}
    \begin{figure}
      \centering
      \includegraphics[width=0.8\textwidth]{c4_case_line_other_02.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_case_line_other_06.png}
  \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{使用相同的数据同时取悦共和党和民主党}
    \begin{figure}
      \centering
      \includegraphics[width=0.51\textwidth]{c4_case_line_other_04.png}\quad
      \includegraphics[width=0.42\textwidth]{c4_case_line_other_05.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{德国纺织工业去向何方}
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{c4_case_line_other_07.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{美国制造业的完整故事}
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{c4_case_line_other_03.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{双雄争霸 vs. 三足鼎立}
    \begin{figure}
      \centering
      \includegraphics[width=0.7\textwidth]{c4_case_line_radio_01.png}
    \end{figure}
    \vspace{-1em}
    \pause
...
\begin{frame}
  ...
  \begin{block}{一个过去的趋势在未来的10年得到了进一步的延续与升级}
    \begin{figure}
      \centering
      \includegraphics[width=0.6\textwidth]{c4_case_line_ten_01.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{黄金价格的未来趋势}
    \begin{figure}
      \centering
      \includegraphics[width=0.6\textwidth]{c4_case_line_gold_01.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.43\textwidth]{c4_case_line_shock_02.png}\quad
    \includegraphics[width=0.52\textwidth]{c4_case_line_shock_03.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_case_line_hiv_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{农田需求}
    \begin{figure}
      \centering
      \includegraphics[width=0.7\textwidth]{c4_case_line_land_01.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{大气环境中的二氧化碳}
    \begin{figure}
      \centering
      \includegraphics[width=0.48\textwidth]{c4_case_line_air_01.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  \frametitle{案例 | 趋势 | 近视率飙升}
    \begin{figure}
      \centering
      \includegraphics[width=0.28\textwidth]{c4_case_line_eye_02.jpg}
    \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{案例 | 趋势 | 二氧化碳排放}
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{c4_case_line_co2_01.jpg}
    \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_case_1d_bar_01.png}
  \end{figure}
  \vspace{-1em}
  \begin{block}{解析}
    \begin{itemize}
...
\begin{frame}
  \frametitle{案例 | 维度 | 工资}
  \begin{block}{钱袋图}
    画一个钱袋用来表示罗坦提亚人的15英镑，然后再画一个高两倍的钱袋代表英国佬的30英镑。还是1:2的比例……\visible<2->{对吗？}
  \end{block}
  \vspace{-0.5em}
  \begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{c4_case_1d_bag_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<1->{\includegraphics[width=0.23\textwidth]{c4_case_1d_income_01.png}}
    \visible<2->{\includegraphics[width=0.38\textwidth]{c4_case_1d_income_02.png}}
    \visible<3->{\includegraphics[width=0.35\textwidth]{c4_case_1d_income_03.png}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{联邦德国新州和老州的住房面积}
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{c4_case_1d_house_01.png}
    \end{figure}
    \vspace{-0.5em}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{c4_case_1d_car_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.43\textwidth]{c4_case_1d_co2_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_case_1d_om_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{c4_case_1d_drug_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c4_case_1d_trash_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{c4_case_1d_box_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c4_case_1d_iron_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c4_case_1d_nn_01.png}
  \end{figure}
  \vspace{-1em}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.55\textwidth]{c4_case_1d_xn_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c4_case_ele_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{哪里是世界的中心？}
    \begin{figure}
      \centering
      \includegraphics[width=0.5\textwidth]{c4_case_world_01.png}\quad
      \includegraphics[width=0.43\textwidth]{c4_case_world_02.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{联邦德国的居民密度}
    \begin{figure}
      \centering
      \includegraphics[width=0.7\textwidth]{c4_case_population_01.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{“空的”医生职位}
    \begin{figure}
      \centering
      \includegraphics[width=0.75\textwidth]{c4_case_doctor_01.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  \frametitle{案例 | 地图 | 全球$CO_2$分布图}
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{c4_case_oco_01.jpg}
    \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{案例 | 地图 | 美国的污染}
    \begin{figure}
      \centering
      \includegraphics[width=0.8\textwidth]{c4_case_usa_01.jpg}
    \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{c4_escher_05.jpg}\quad
    \includegraphics[width=0.47\textwidth]{c4_escher_30.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{c4_escher_07.jpg}\quad
    \includegraphics[width=0.47\textwidth]{c4_escher_08.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.58\textwidth]{c4_escher_32.jpg}\quad
    \includegraphics[width=0.37\textwidth]{c4_escher_36.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.54\textwidth]{c4_escher_31.jpg}\quad
    \includegraphics[width=0.42\textwidth]{c4_escher_34.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.39\textwidth]{c4_escher_20.jpg}\quad
    \includegraphics[width=0.53\textwidth]{c4_escher_21.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.39\textwidth]{c4_escher_01.jpg}\quad
    \includegraphics[width=0.56\textwidth]{c4_escher_02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{block}{魔鬼叉子}
      \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{c4_escher_40.png}
      \end{figure}
    \end{block}
    \column{0.5\textwidth}
    \begin{block}{彭罗斯阶梯}
      \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{c4_escher_41.png}
      \end{figure}
    \end{block}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{block}{不可能的方块}
      \begin{figure}
        \centering
        \includegraphics[width=0.93\textwidth]{c4_escher_39.png}
      \end{figure}
    \end{block}
    \column{0.5\textwidth}
    \begin{block}{潘洛斯三角}
      \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{c4_escher_24.png}
      \end{figure}
    \end{block}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{block}{莫比乌斯带}
      \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{c4_escher_22.jpg}
      \end{figure}
    \end{block}
    \column{0.3\textwidth}
    \begin{block}{克莱因瓶}
      \begin{figure}
        \centering
        \includegraphics[width=0.93\textwidth]{c4_escher_23.png}
      \end{figure}
    \end{block}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{c4_escher_09.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.51\textwidth]{c4_fun_01.jpg}\quad
    \includegraphics[width=0.45\textwidth]{c4_fun_04.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.53\textwidth]{c4_fun_02.jpg}\quad
    \includegraphics[width=0.4\textwidth]{c4_fun_03.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.41\textwidth]{c4_fun_05.jpg}\quad
    \includegraphics[width=0.55\textwidth]{c4_fun_06.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{c4_fun_07.jpg}\quad
    \includegraphics[width=0.39\textwidth]{c4_fun_08.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{c4_fun_09.jpg}\quad
    \includegraphics[width=0.45\textwidth]{c4_fun_10.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{c4_fun_11.jpg}\quad
    \includegraphics[width=0.4\textwidth]{c4_fun_12.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.44\textwidth]{c4_fun_13.jpg}\quad
    \includegraphics[width=0.49\textwidth]{c4_fun_14.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{c4_fun_15.jpg}\quad
    \includegraphics[width=0.44\textwidth]{c4_fun_16.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.57\textwidth]{c4_fun_20.jpg}\quad
    \includegraphics[width=0.38\textwidth]{c4_fun_21.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<1->{\includegraphics[width=0.35\textwidth]{c4_fun_17.jpg}}\quad
    \visible<2->{\includegraphics[width=0.56\textwidth]{c4_fun_18.jpg}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c4_keyword_2017.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c4_keyword_2018.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c4_keyword_percent_2018.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.88\textwidth]{c4_twins.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c4_ideas.jpg}
  \end{figure}
\end{frame}
