...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.42\textwidth]{c4.plot.venn.01.png}
    \includegraphics[width=0.53\textwidth]{c4.plot.venn.02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{案例 | 趋势 | 近视率飙升}
    \begin{figure}
      \centering
      \includegraphics[width=0.28\textwidth]{c4.case.line.eye.02.jpg}
    \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{案例 | 趋势 | 二氧化碳排放}
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{c4.case.line.co2.01.jpg}
    \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c4.case.ele.01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{案例 | 地图 | 全球$CO_2$分布图}
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{c4.case.oco.01.jpg}
    \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{案例 | 地图 | 美国的污染}
    \begin{figure}
      \centering
      \includegraphics[width=0.8\textwidth]{c4.case.usa.01.jpg}
    \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<1->{\includegraphics[width=0.35\textwidth]{c4.fun.17.jpg}}\quad
    \visible<2->{\includegraphics[width=0.56\textwidth]{c4.fun.18.jpg}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c4.keyword.2017.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c4.keyword.2018.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c4.keyword.percent.2018.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.88\textwidth]{c4.twins.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c4.ideas.jpg}
  \end{figure}
\end{frame}
