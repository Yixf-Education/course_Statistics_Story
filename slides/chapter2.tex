...
\begin{frame}
  ...
  \begin{figure}
    ...
    \visible<2->{\includegraphics[width=0.65\textwidth]{c2.percentile.02.png}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \visible<2->{\includegraphics[width=0.6\textwidth]{c2.percentile.04.png}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<2->{\includegraphics[width=0.35\textwidth]{c2.football.01.jpg}}
  \end{figure}
  \pause
  \vspace{-1em}
  \begin{block}{规则}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<1->{\includegraphics[width=0.45\textwidth]{c2.swsl.man.01.png}}\quad
    \visible<1->{\includegraphics[width=0.45\textwidth]{c2.swsl.woman.01.png}}\\
    \visible<2->{\includegraphics[width=0.45\textwidth]{c2.swsl.baby.birth.01.png}}\quad
    \visible<3->{\includegraphics[width=0.45\textwidth]{c2.swsl.baby.death.01.png}}\\
    \visible<4->{\includegraphics[width=0.9\textwidth,height=0.36\textheight]{c2.swaziland.correlation.png}}
  \end{figure}
\end{frame}
