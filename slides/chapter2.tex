...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c2_mmm_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c2_mmm_02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c2_mmm_03.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.65\textwidth]{c2_percentile_01.jpg}
    \visible<2->{\includegraphics[width=0.65\textwidth]{c2_percentile_02.png}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c2_percentile_03.jpg}
    \visible<2->{\includegraphics[width=0.6\textwidth]{c2_percentile_04.png}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{c2_income_01.png}
  \end{figure}
\end{frame}
...
收入的分布不再像钟形一样对称，而是有偏的，它的形状类似于孩子玩的滑梯，梯子一侧是陡斜地升到顶部，而滑道一侧则缓慢向下倾斜。此时，均值与中位数、众数相差甚远。
  ...
  \begin{figure}
    \centering
    \visible<2->{\includegraphics[width=0.4\textwidth]{c2_income_02.png}}\quad
    \visible<2->{\includegraphics[width=0.43\textwidth]{c2_income_03.png}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{c2_md_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c2_gongsi_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c2_money_01.jpg}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<1->{\includegraphics[width=0.78\textwidth]{c2_movie_01.png}}\\
    \visible<2->{\includegraphics[width=0.78\textwidth]{c2_movie_02.png}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c2_coin_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c2_usa_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c2_tiaosheng_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c2_xiaoxin_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<2->{\includegraphics[width=0.35\textwidth]{c2_football_01.jpg}}
  \end{figure}
  \pause
  \vspace{-1em}
  \begin{block}{规则}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c2_height_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  % \begin{figure}
  %   \centering
  %   \includegraphics[width=0.48\textwidth]{c2_swsl_man_01.png}
  %   \includegraphics[width=0.48\textwidth]{c2_swsl_woman_01.png}
  % \end{figure}
  % \vspace{-1em}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<1->{\includegraphics[width=0.45\textwidth]{c2_swsl_man_01.png}}\quad
    \visible<1->{\includegraphics[width=0.45\textwidth]{c2_swsl_woman_01.png}}\\
    \visible<2->{\includegraphics[width=0.45\textwidth]{c2_swsl_baby_birth_01.png}}\quad
    \visible<3->{\includegraphics[width=0.45\textwidth]{c2_swsl_baby_death_01.png}}\\
    \visible<4->{\includegraphics[width=0.9\textwidth,height=0.36\textheight]{c2_swaziland_correlation.png}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{癌症存活率}
    \begin{itemize}
      \item 古尔德，腹部间皮癌（1985年提出\alert{“相同生物个体间存在差异”}的观点。他指出，以往对癌症病人存活率的统计让人忽略了病人个体情况的研究。）
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c2_travel_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{c2_benford_01.jpg}\\
    \includegraphics[width=0.6\textwidth]{c2_benford_02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.48\textwidth]{c2_benford_03.png}
    \includegraphics[width=0.48\textwidth]{c2_benford_04.png}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{齐夫定律}
  \begin{block}{齐夫定律（1949年，实验定律，非理论定律）}
    \begin{itemize}
      \item 在自然语言的语料库里，一个单词出现的频率与它在频率表里的排名成反比。
      \item 频率最高的单词出现的频率大约是出现频率第二位的单词的2倍，而出现频率第二位的单词则是出现频率第四位的单词的2倍。
    \end{itemize}
  \end{block}
  \pause
  \begin{block}{齐夫定律实例}
    在Brown语料库中，“the”、“of”、“and”是出现频率最前的三个单词，其出现的频数分别为69971次、36411次、28852次，大约占整个语料库100万个单词中的7\%、3.6\%、2.9\%，其比例约为6：3：2。
  \end{block}
  \pause
  \begin{block}{遵循齐夫定律的现象}
    \begin{itemize}
      \item 单词的出现频率（不仅适用于语料全体，也适用于单独的一篇文章）
      \item 网页访问频率、城市人口、收入前3\%的人的收入、地震震级、固体破碎时的碎片大小
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c2_gapminder_2016.png}
  \end{figure}
  % \begin{itemize}
...
\begin{frame}
  ...
  \begin{block}{平均值 vs. 世界的多样化}
    \begin{itemize}
      \item 平均值只能够说个大概，这是它们天生的说话方式。用这么简单的方式来描述一个群体，重要的细节无可避免就会被含糊带过。平均值就像晚间新闻的一句结语，简单地说出记者所归纳的重点，但是没看过报道的观众，还是不知道具体的新闻内容是什么。它向来有个问题，宣称自己为这个万花筒般的世界发声，却扼杀了我们所有的想象。\alert{想要看穿平均值的真面目，首先你得记得世界的多样化}。
