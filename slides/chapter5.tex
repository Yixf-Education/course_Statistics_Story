...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.3\textwidth]{c5.daoli.01.png}\\
    \includegraphics[width=0.45\textwidth]{c5.daoli.02.png}
    \includegraphics[width=0.45\textwidth]{c5.daoli.03.png}
  \end{figure}
\end{frame}
