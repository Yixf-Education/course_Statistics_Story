...
\begin{frame}
  \frametitle{案例 | 趋势 | 新闻发言人对企业经营业绩的操作}
...
\begin{frame}
  \frametitle{案例 | 趋势 | 德意志银行的顾客发展演变过程}
  \begin{figure}
    \centering
...
\begin{frame}
  \frametitle{案例 | 一维图形 | 欧盟国中每个就业者的补贴状况}
  \begin{figure}
    \centering
