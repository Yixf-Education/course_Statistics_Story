...
\begin{frame}
  ...
  \begin{block}{青少年具有较多自杀倾向}
    一家德国报纸文章“老年时会变得更幸福”分析论证了下面的结果：在20岁以下的强少年中，自杀在所有死亡中所占的比例最大，共计25\%。而30～40岁的人自杀率占到10\%，超过70岁的老年人自杀率不足2\%。“年龄越大，决定自杀的比率就越低”。
  \end{block}
  \pause \pause \pause \pause
  \begin{block}{解析}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{c3.simpson.01.png}\\
    \includegraphics[width=0.5\textwidth]{c3.simpson.03.png}
  \end{figure}
\end{frame}
