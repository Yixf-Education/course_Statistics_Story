...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.35\textwidth]{c3.dashu.02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c3.compare.02.png}
  \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<2->{\includegraphics[width=0.23\textwidth]{c3.fangyan.01.jpg}}
    \visible<2->{\includegraphics[width=0.23\textwidth]{c3.fangyan.02.jpg}}
    \visible<3->{\includegraphics[width=0.23\textwidth]{c3.fangyan.03.jpg}}
    \visible<3->{\includegraphics[width=0.23\textwidth]{c3.fangyan.04.jpg}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<1->{\includegraphics[width=0.5\textwidth]{c3.simpson.011.png}}\\
    \vspace{0.5em}
    \visible<2->{\includegraphics[width=0.5\textwidth]{c3.simpson.012.png}}\\
    \vspace{0.5em}
    \visible<3->{\includegraphics[width=0.5\textwidth]{c3.simpson.01.png}}
  \end{figure}
\end{frame}
