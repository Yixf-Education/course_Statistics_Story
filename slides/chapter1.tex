...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c1_sampling_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{选择性偏见}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.5\textwidth]{c1_news_01.jpg}
    \end{figure}
  \end{block}
\end{frame}
...
在二战中，美国人曾经研究了他们的轰炸机如何才能避开德国的防空炮火而击中目标：轰炸机的哪一部分最经常被敌机击中，在飞机的什么部位增加装甲防护是必要的？
  ...
  \begin{figure}
    \centering
    %\includegraphics[width=0.6\textwidth]{c1_plane_01.png}
    \includegraphics[width=0.6\textwidth]{c1_plane_04.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{案例分析 | 其他案例}
    \begin{figure}
      \centering
      \includegraphics[width=0.45\textwidth]{c1_ticket_01.jpg}\quad
      \includegraphics[width=0.4\textwidth]{c1_baby_01.jpg}
    \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{c1_trump_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c1_pvss_02.jpg}\\
    \vspace{0.5em}
    \includegraphics[width=0.45\textwidth]{c1_pvss_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c1_sm_01.png}\\
    \vspace{0.5em}
    \includegraphics[width=0.5\textwidth]{c1_sm_02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{c1_sme_02.jpg}\\
    \vspace{0.5em}
    \includegraphics[width=0.45\textwidth]{c1_sme_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c1_se_01.jpg}
  \end{figure}
  \pause
  \begin{block}{思考}
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c1_se_02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c1_se_03.jpg}
  \end{figure}
\end{frame}
